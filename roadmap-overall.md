...
| 0.5 | Pillar I production asterisks | **H4** covering noisy BK at prod-shaped *N* **or** cookbook “demo *N* only”; optional crypto ℓ=2 NTT tile (**H3**) | **C33** Track A Metal covering-`.crypto` *B*=1 PASS; ε≈−8.4 (**C32**); still not −64 |
