...
| 0.5 | Pillar I production asterisks | **H4** covering noisy BK at prod-shaped *N* **or** cookbook “demo *N* only”; optional crypto ℓ=2 NTT tile (**H3**) | **C34** baseLog=4 + *B*=1 → ε≈−913 + Metal PASS; torus *B*~128 still open |
