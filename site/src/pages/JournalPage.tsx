          ...
          <div className="timeline">
            ...
            <article className="tl-item">
              ...
              <div className="prose">
                ...
                <p>
                  The corpus independently confirms one new exact radio phrase: <code>FFFTTTBLEIBTBESETZT</code> in P1030668. Its short core is mechanically weak, but the exact 40-letter source context yields four single-component, 18-loop alignment hypotheses. They are staged and unrun behind the existing full-middle-ring arm, which remains the next GPU priority at 1/24. Before that tranche starts, the team reports these findings and the exact command scope back to Selm and incorporates any correction or archive reply first.
                </p>
              </div>
            </article>
          </div>
