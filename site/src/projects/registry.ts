...
export const projects: Project[] = [
  {
    ...
    stakes: [
      ...
      'Nazi Blaster 9000 settings 1..<256 stripe is complete: 0 BREAK gates; Ostwald 4-plug greeting recovered known P1030684; wrong-setting ghost is running',
    ...
    pages: [
      {
        ...
        label: 'Project hub',
        kind: 'hub',
        blurb: 'HELUT-side entry; the public historian wing is /enigma',
      },
      {
        path: '/enigma/p1030680',
        label: 'The message',
        kind: 'essay',
        blurb: 'P1030680 dossier for Enigma historians',
      },
      {
        path: '/enigma/corpus',
        label: 'U-534 corpus',
        kind: 'essay',
        blurb: 'Hörenberg scrape, downloadable JSON',
      },
      {
        path: '/enigma/journal',
      ...
      {
        path: '/enigma/nazi-blaster-9000',
        label: 'Nazi Blaster 9000',
        kind: 'lab',
        blurb: 'The search machine, kept apart from the hunt ledger',
      },
      {
        path: '/enigma/mulein-board',
        label: 'Mulein board',
        kind: 'lab',
        blurb: 'Tolerant/indel diagonal board',
      },
    ],
