...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary:
      'Covering Track A noisy BK at N=1024 k=7 is C52–C54; covering-b2 cheaper SING + regex is C57. C62 is noiseless PicoRV at that N; C63 is covering PicoRV at N=64; C64 is extract→KS n=64 native-k covering (not LWE-176). Native k=1 at n=N and cryptoPublicMS remain graded. Sage filled C23; H1 still applies.',
    stakes: [
      ...
      'Covering public-MS at N=1024 uses stride-k wires, not “g₀=δ exact covering” (C27 still {8,128}); C55/C56 negatives; C64 extract→KS n=64 native-k covering SING; C60/C61 PicoRV covering Q FAIL at N=1024 (C63 PASS at N=64)',
    ],
    pages: [
      {
