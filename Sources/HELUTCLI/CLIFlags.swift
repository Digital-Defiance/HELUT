...
public let positionalArgs: [String] = {
    ...
    let valueFlags: Set<String> = [
        ...
        "--bombe-from", "--bombe-min-crib", "--bombe-fixture", "--bombe-exact-plugs",
        ...
        "--mulein-future-manifest-source", "--mulein-future-manifest-out",
        "--mulein-future-manifest-delta",
        "--mulein-future-settings", "--mulein-future-repetitions",
        "--mulein-future-bank-lanes", "--mulein-future-tensorlut-json",
        "--mulein-future-tick-limit",
        "--mulein-future-manifest", "--mulein-future-netlist", "--mulein-bank-lanes",
        "--shell-from", "--shell-count", "--setting-from", "--setting-count",
        "--future-from", "--future-count", "--chunk-settings", "--tensor-batch",
        "--campaign-ledger",
        "--mulein-ostwald-adapt", "--mulein-ostwald-adapt-out",
        "--mulein-ostwald-adapt-skip-out", "--mulein-ostwald-adapt-limit",
        "--mulein-ostwald-min-pairs", "--mulein-ostwald-family",
        "--ostwald-wrong", "--ostwald-lengths", "--ostwald-scorer", "--ostwald-controls",
        "--ostwald-exhaust", "--ostwald-exhaust-depth", "--ostwald-top-up",
        "--ostwald-brute-plugs", "--ostwald-memory-gb",
        "--ostwald-seed", "--ostwald-escalate", "--ostwald-keep", "--ostwald-reconnect", "--ostwald-beam",
        "--ostwald-ranker-decoy-climbs", "--ostwald-locked-plugs", "--ostwald-plugs",
        "--ostwald-shell", "--ostwald-shell-index",
        "--ostwald-setting-from", "--ostwald-setting-count", "--ostwald-control",
        "--garble-crib", "--garble-tolerance", "--garble-offset", "--ostwald-lexicon",
