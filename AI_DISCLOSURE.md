# AI Disclosure: The Architect and the Engine

**Regarding the use of AI in this repository:**

I use AI. I rely on it heavily.

Let me be explicitly clear about the boundary between the architect and the machine. This is not blindly generated code. I am a systems architect with 35 years of engineering experience. I am the orchestrator. The AI is the typist. Every line of code generated is subjected to hostile review. The AI does not invent the continuous-to-discrete logic loops; I do. The AI writes the boilerplate to test them. I force it to reproduce results and pass brutal metrics. I trust it as far as the compiler can verify it.
