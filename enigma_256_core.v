...
module enigma_256_core (
    ...
    always @(posedge clk) begin
        if (wr_en) begin
            case (wr_sel)
                ...
                4'd9: reflector[wr_addr] <= wr_data;
                default: /* ignore */ ;
            endcase
        end
    end
    ...
    // =========================================================================
    // 4. SEQUENTIAL: load / step / registered I/O
    // =========================================================================
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            // Emit scrambled byte under *current* offsets, then step (Swift oracle parity).
