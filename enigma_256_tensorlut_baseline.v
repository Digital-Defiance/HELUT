module enigma_256_tensorlut_baseline (
    ...
    LUT6 #(
        ...
        .I0(n[56]), .I1(n[14]), .I2(n[31]), .I3(n[57]), .I4(n[59]), .I5(n[64]),
        .O(n[69])
    );
    LUT6 #(
        .INIT(64'h807F7F7F7F808080)
    ) lut_1 (
        .I0(n[48]), .I1(n[32]), .I2(n[45]), .I3(n[51]), .I4(n[53]), .I5(n[62]),
        .O(n[68])
    );
    LUT6 #(
        .INIT(64'h807F7F7F7F808080)
    ) lut_2 (
        .I0(n[33]), .I1(n[9]), .I2(n[11]), .I3(n[40]), .I4(n[52]), .I5(n[61]),
        .O(n[67])
    );
    LUT6 #(
        .INIT(64'h807F7F7F7F808080)
    ) lut_3 (
        .I0(n[19]), .I1(n[6]), .I2(n[17]), .I3(n[25]), .I4(n[28]), .I5(n[63]),
        .O(n[66])
    );
