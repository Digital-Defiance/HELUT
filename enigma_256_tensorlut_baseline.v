module enigma_256_tensorlut_baseline (
    ...
    LUT6 #(
        ...
        .I0(n[13]), .I1(n[19]), .I2(n[25]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[69])
    );
    LUT6 #(
        .INIT(64'h7878787878787878)
    ) lut_1 (
        .I0(n[5]), .I1(n[6]), .I2(n[14]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[68])
    );
    LUT6 #(
        .INIT(64'h7878787878787878)
    ) lut_2 (
        .I0(n[2]), .I1(n[8]), .I2(n[17]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[67])
    );
    LUT6 #(
        .INIT(64'h7878787878787878)
    ) lut_3 (
        .I0(n[4]), .I1(n[10]), .I2(n[23]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[66])
    );
