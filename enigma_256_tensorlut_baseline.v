module enigma_256_tensorlut_baseline (
    ...
    LUT6 #(
        ...
        .I0(n[49]), .I1(n[56]), .I2(n[63]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[69])
    );
    LUT6 #(
        .INIT(64'h7878787878787878)
    ) lut_1 (
        .I0(n[33]), .I1(n[40]), .I2(n[47]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[68])
    );
    LUT6 #(
        .INIT(64'h7878787878787878)
    ) lut_2 (
        .I0(n[17]), .I1(n[24]), .I2(n[31]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[67])
    );
    LUT6 #(
        .INIT(64'h7878787878787878)
    ) lut_3 (
        .I0(n[2]), .I1(n[9]), .I2(n[14]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[66])
    );
