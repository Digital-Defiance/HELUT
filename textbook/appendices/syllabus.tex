...
The thing being assessed is whether a hedge survives contact with a question.
Stating \hid{1} and then, under follow-up, sliding into ``so it is 176-bit
secure'' is the characteristic failure mode, and noticing it in your own
sentence is the skill the course is trying to build. Treat it as the main
rubric line and as something to discuss in the viva --- not as an automatic
fail. Everyone does it once; the difference between a student who has learned
the material and one who has not is whether they catch themselves.
