...
ID & Asterisk \\
\midrule
\hid{1} & \cid{23} filled JSON. Production $|\Delta|=4.5$; 4/8 anchors exceed 16-bit tolerance. \\
\hid{2} & \textbf{Closed} 2026-08-12 ($Z_{2N}$ pack). Kept as history. \\
\hid{3} & \cid{20}/\cid{21} SING bars met; serial NTT SING still loses vs persist; Sage \hid{1} pending. \\
\hid{4} & \cid{22}/\cid{26}/\cid{27}: covering only at $N\in\{8,128\}$ under $q{=}2^{32}$; product $N{=}1024$ inject fails. Metal SING still $e{=}0$ BK. \\
