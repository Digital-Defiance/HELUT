...
Examples: microbench identity LUT; full\_adder boolean SING.
...
to have invented TFHE, and does not offer production key sizes until a lattice
estimator fills the pending JSON (\hid{1}).
