...
calibrated $\sim 176$ and is \emph{not} a lattice-estimator attack cost on
every row---Sage filled \corpus{logs/helut-estimator-results.json} (\cid{23});
print \hid{1} with the number.
...
\texttt{cryptoPublicMS} inject remains \cid{26}; native $k{=}1$ remains \cid{37}. \\
\bottomrule
\end{tabular}
\end{center}
...
$B_{\mathrm{bk}}$ & covering Track~A \cid{52}--\cid{54}; native $k{=}1$ still \cid{37} & \hid{4} remainder \\
