...
\hid{4} Noisy BK
  & \cid{52}--\cid{54} covering Track A $k{=}7$ $\sigma{=}128$ @ $N{=}1024$ ($\varepsilon$ + SING)
  & Native $k{=}1$ (\cid{37}/\cid{55}); \texttt{cryptoPublicMS} (\cid{26}/\cid{56}); PicoRV covering LUT-tax. \\
