...
\hid{1} Sage lattice-estimator
  & \cid{23} JSON filled; production $|\Delta|=4.5$
  & Tighten HELUT vs estimator where $|\Delta|>16$. \\
\hid{3} Metal BR at large $N$
  & \cid{20} boolean $10.6\,\mathrm{s}$; \cid{21} crypto $\ell=2$ $11.38\,\mathrm{s}$
  & NTT inside the crypto $\ell=2$ tile. \\
\hid{4} Noisy BK
  & \cid{22} covering $N\le 128$; \cid{26} $N{=}1024$ inject graded fail; SING $e{=}0$
  & Gadget/$\sigma$ that meets $\varepsilon\le 2^{-64}$ at production $N$. \\
Campaign catalog
