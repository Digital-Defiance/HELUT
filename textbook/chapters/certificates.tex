...
\reproduced{C27}{Exact public-MS covering under $q{=}2^{32}$: among
$N\in\{8,\ldots,2048\}$, only $N{=}8$ and $N{=}128$. $N{=}1024$ cannot be both
$g_0=\delta$ and covering (Theorem~3 /
\texttt{GGSWPublicMSCovering.certificate()}).}
