module enigma_256_step_cone_tensorlut (
    ...
    LUT6 #(
        ...
        .I0(n[109]), .I1(n[73]), .I2(n[94]), .I3(n[121]), .I4(n[84]), .I5(n[130]),
        .O(n[137])
    );
    LUT6 #(
        .INIT(64'h807F7F7F7F808080)
    ) lut_85 (
        .I0(n[91]), .I1(n[106]), .I2(n[72]), .I3(n[81]), .I4(n[118]), .I5(n[125]),
        .O(n[136])
    );
    LUT6 #(
        .INIT(64'h807F7F7F7F808080)
    ) lut_86 (
        .I0(n[103]), .I1(n[71]), .I2(n[88]), .I3(n[79]), .I4(n[114]), .I5(n[128]),
        .O(n[135])
    );
    LUT6 #(
        .INIT(64'h807F7F7F7F808080)
    ) lut_87 (
        .I0(n[97]), .I1(n[83]), .I2(n[70]), .I3(n[111]), .I4(n[75]), .I5(n[132]),
        .O(n[134])
    );
    LUT6 #(
        .INIT(64'hAAAA3C00AAAA3C00)
