module enigma_256_step_cone_tensorlut (
    ...
    LUT6 #(
        ...
        .I0(n[87]), .I1(n[81]), .I2(n[93]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[137])
    );
    LUT6 #(
        .INIT(64'h7878787878787878)
    ) lut_85 (
        .I0(n[73]), .I1(n[74]), .I2(n[82]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[136])
    );
    LUT6 #(
        .INIT(64'h7878787878787878)
    ) lut_86 (
        .I0(n[76]), .I1(n[70]), .I2(n[85]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[135])
    );
    LUT6 #(
        .INIT(64'h7878787878787878)
    ) lut_87 (
        .I0(n[78]), .I1(n[72]), .I2(n[91]), .I3(1'b0), .I4(1'b0), .I5(1'b0),
        .O(n[134])
    );
    LUT6 #(
        .INIT(64'hAAAA3C00AAAA3C00)
