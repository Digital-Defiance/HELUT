...
package enum Enigma256GenerationError: Error, Equatable {
    ...
    case unsupportedReflectorDerivation(String)
    case unsupportedCenterReservedPairRule(String)
    case unsupportedCenterMode(String)
...
package struct Enigma256Generation: Sendable, Equatable, Codable {
    package static let supportedFixtureSchemaVersion = 3
    package static let transitionIdentifier = "right_shift_lsb_galois_d800000000000000"
    package static let updateOrderIdentifier = "derive_prestep_mask_scramble_then_step_same_mask"
    package static let reflectorDerivationIdentifier = "fisher_yates_2_through_255_pairing_reserved_0_1_v1"
    package static let centerReservedPairRuleIdentifier = "0_1_identity_only_when_center_mode_else_base_reflector"
    package static let centerModeIdentifier = "prestep_step_r1_xor_step_r2_xor_step_r3_xor_step_r4"
    package static let centerMapOrderIdentifier = "forward_rotors_center_then_reverse_rotors_v1"
    ...
    package static let v2Gen0ProfileSHA256 = "2a9f54c70a1619805a911758158f1e2204b0fd96c35102a9db5f4575aeb40cb0"
    ...
    package let reflectorDerivation: String
    package let centerReservedPairRule: String
    package let centerMode: String
    ...
    package static let v2Gen0 = Enigma256Generation(
        ...
        reflectorDerivation: reflectorDerivationIdentifier,
        centerReservedPairRule: centerReservedPairRuleIdentifier,
        centerMode: centerModeIdentifier,
    ...
    package init(
        ...
        updateOrder: String,
        reflectorDerivation: String,
        centerReservedPairRule: String,
        centerMode: String,
        ...
        self.reflectorDerivation = reflectorDerivation
        self.centerReservedPairRule = centerReservedPairRule
    ...
    package func validate() throws {
        ...
        guard reflectorDerivation == Self.reflectorDerivationIdentifier else {
            throw Enigma256GenerationError.unsupportedReflectorDerivation(reflectorDerivation)
        }
        guard centerReservedPairRule == Self.centerReservedPairRuleIdentifier else {
            throw Enigma256GenerationError.unsupportedCenterReservedPairRule(centerReservedPairRule)
        }
        guard centerMode == Self.centerModeIdentifier else {
            throw Enigma256GenerationError.unsupportedCenterMode(centerMode)
        }
    ...
    package var canonicalProfile: Data {
        ...
        return Data(
            "\(family)|\(suiteVersion)|\(id)|\(fixtureSchemaVersion)|\(lfsrTransition)|\(updateOrder)|\(reflectorDerivation)|\(centerReservedPairRule)|\(centerMode)|\(centerMapOrder)|\(formula.rawValue)|\(componentText)|\(foldText)".utf8
        )
    }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case reflectorDerivation = "reflector_derivation"
        case centerReservedPairRule = "center_reserved_pair_rule"
        case centerMode = "center_mode"
