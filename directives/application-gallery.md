...
Next: tree Metal covering at production *N*; PicoRV covering Q at *N*=1024 (**C60**/**C61**; try **C64** `--lwe-dimension`); native *k*=1 at *n*=*N* (**C37**). Figures live in `site/public/gallery/`. FHE chronology: `/projects/netlist-fhe/journal`.
