...
Next: tree Metal covering at production *N*; PicoRV covering at *N*=1024; native *k*=1 (**C37**). Figures live in `site/public/gallery/`. FHE chronology: `/projects/netlist-fhe/journal`.
