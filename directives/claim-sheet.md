...
| **H4** | Noisy BK in product path | **C27**/**C29**: exact covering+*g₀*=*δ* never at *N*=1024 for any power-of-two *q* (widening UInt64 does not help). **Track B Metal closed:** **C28**. **C30**: at *N*=128, inject *B*≤8 prints εlog2=−∞ but σ̂ still ~10⁴–10⁵ (amp). **Track A** (*N*=1024 SING) stays *e*=0 BK (**C26**). Closing Track A needs an **approximate** gadget (or leave *e*=0); not a new power-of-two limb. |
